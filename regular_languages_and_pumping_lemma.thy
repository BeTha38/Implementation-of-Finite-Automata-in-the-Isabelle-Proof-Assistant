...
proposition simga_star_is_regular:
  ...
  using assms existence_of_sigma_star_same_type reg_lang_nfas by fast

proposition comp_is_regular:
  assumes "L \<in> regular_languages \<Sigma>" "infinite (UNIV :: 's set)"
  shows "comp_language \<Sigma> L \<in> regular_languages \<Sigma>"
proof - 
  have "L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> comp_language \<Sigma> L = language_auto NFA_\<A>" using assms existence_of_comp_same_type by metis
  hence "comp_language \<Sigma> L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed

proposition inter_is_regular:
  assumes "L1 \<in> regular_languages \<Sigma>1" "L2 \<in> regular_languages \<Sigma>2" "infinite (UNIV :: 's set)"
  shows "L1 \<inter> L2 \<in> regular_languages (\<Sigma>1 \<union> \<Sigma>2)"
proof - 
  have "L1 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L = language_auto NFA_\<A>} \<and> L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "(\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L1 = language_auto NFA_\<A>) \<and> (\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L2 = language_auto NFA_\<A>)" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<union> \<Sigma>2 \<and> L1 \<inter> L2 = language_auto NFA_\<A>" using assms existence_of_inter_same_type by metis
  hence "L1 \<inter> L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = (\<Sigma>1 \<union> \<Sigma>2) \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed
...
proof - 
  have "L1 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L = language_auto NFA_\<A>} \<and> L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "(\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L1 = language_auto NFA_\<A>) \<and> (\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L2 = language_auto NFA_\<A>)" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<union> \<Sigma>2 \<and> L1 \<union> L2 = language_auto NFA_\<A>" using assms existence_of_union_same_type by metis
  hence "L1 \<union> L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = (\<Sigma>1 \<union> \<Sigma>2) \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed
...
proof - 
  have "L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> rev_language L = language_auto NFA_\<A>" using assms existence_of_rev_same_type by metis
  hence "rev_language L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed
...
proof - 
  have "L1 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L = language_auto NFA_\<A>} \<and> L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "(\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<and> L1 = language_auto NFA_\<A>) \<and> (\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>2 \<and> L2 = language_auto NFA_\<A>)" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma>1 \<union> \<Sigma>2 \<and> concatenation_language L1 L2 = language_auto NFA_\<A>" using assms existence_of_conc_same_type by metis
  hence "concatenation_language L1 L2 \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = (\<Sigma>1 \<union> \<Sigma>2) \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed
...
proof - 
  have "L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" using assms reg_lang_nfas by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>" by blast
  hence "\<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> kleene_star_language L = language_auto NFA_\<A>" using assms kleene_star_eps_free_main by metis
  hence "kleene_star_language L \<in> {L . \<exists> (NFA_\<A> :: ('s, 'a) automaton) . auto_well_defined NFA_\<A> \<and> alphabet NFA_\<A> = \<Sigma> \<and> L = language_auto NFA_\<A>}" by blast
  thus ?thesis using assms reg_lang_nfas by blast
qed
...
proof - 
  have "L \<in> regular_languages \<Sigma> \<and> regular_languages \<Sigma> = {L . \<exists> (DFA_\<A> :: ('s, 'a) automaton) . auto_well_defined DFA_\<A> \<and> DFA_property DFA_\<A> \<and> alphabet DFA_\<A> = \<Sigma> \<and> L = language_auto DFA_\<A>}" using assms reg_lang_dfas by blast
  then obtain \<A> :: "('s, 'a) automaton" where "auto_well_defined \<A> \<and> DFA_property \<A> \<and> alphabet \<A> = \<Sigma> \<and> L = language_auto \<A>" by blast
